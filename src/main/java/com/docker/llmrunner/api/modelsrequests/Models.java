...
public class Models implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link Models} and sets the default values.
     */
    public Models() {
     ...
     * @return a {@link Models}
     */
    @jakarta.annotation.Nonnull
    public static Models createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
